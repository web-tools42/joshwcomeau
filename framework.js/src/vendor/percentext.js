(function ( $ ) {
  ...
  function get_parent_width($elem, $container, user_css) {
    ...
    console.log("Container first", $container[0]);
    console.log("Container width", $container[0].width());
    var result = $container.width() - user_css.paddingLeft - user_css.paddingRight - user_css.marginLeft - user_css.marginRight;
    return result;
  }  
